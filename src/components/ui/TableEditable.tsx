    ...
    return (
        ...
        >
            <table className="min-w-full divide-y divide-gray-200">
                ...
                {data.length === 0 ? (
                    <tr>
                        <td colSpan={columns.length + (onSave ? 1 : 0)} className="py-6 text-center text-gray-400 text-sm">
                            {emptyMessage}
                        </td>
                    </tr>
                ) : (
                    data.map(item => {
                        ...
                        return (
                            ...
                            >
                                {columns.map(col => (
                                    <td key={String(col.key)} className={`px-4 py-3 text-sm text-gray-700 text-${col.align || "left"}`}>
                                        {col.render
