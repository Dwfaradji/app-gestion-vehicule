...
//     children: ReactNode;
//     defaultOpen?: boolean;
//     open?: boolean; // ✅ état contrôlé depuis parent
//     onToggle?: (isOpen: boolean) => void; // ✅ callback vers parent
//     length?: number;
//     icon?: ReactNode;
//     disabled?: boolean;
// }
...
//
//     // 🔄 ouverture auto si pas de contenu
//     useEffect(() => {
//         if (length === 0) setInternalOpen(true);
//     }, [length]);
//
//     // 🔄 si "open" est contrôlé depuis le parent, on suit sa valeur
...
//     };
//
//     // ✅ helper pour le parent : fermer uniquement si ouvert
//     const closeIfOpen = () => {
//         if (isOpen) {
...
//     };
//
//     // 💡 expose la méthode au parent via callback si besoin
//     useEffect(() => {
//         (window as any).closeCollapsible = closeIfOpen; // optionnel : pour tests manuels
//     }, [isOpen]);
//
//     return (
...
//                     isOpen ? "max-h-[1000px] opacity-100 p-4" : "max-h-0 opacity-0 p-0"
//                 }`}
//             >
//                 {length === 0 ? (
//                     <div className="text-gray-500 italic">Aucun élément</div>
//                 ) : (
//                     children
//                 )}
//             </div>
    ...
    return (
        <div className="border border-gray-200 rounded-xl bg-gray-50 shadow-sm overflow-hidden transition-all duration-300">
          ...
          ${disabled || length === 0 ? "cursor-not-allowed text-gray-400 bg-gray-100" : "hover:bg-gray-100"}`}
            ...
            <div className={`transition-all duration-300 ${isOpen ? "max-h-[1000px] opacity-100 p-4" : "max-h-0 opacity-0 p-0"}`}>
