...
const FormulaireTrajet = ({ vehicule, conducteur, trajetId, maxAttempts = 5, onTrajetUpdated }: FormulaireTrajetProps) => {
    ...
    const handleScan = (text: string) => {
        ...
        if (scannedVehiculeId !== vehicule.id) return showSnackbar("Ce QR code ne correspond pas à ce véhicule ❌", "error");
    ...
    const handleSubmit = async () => {
        ...
        const anomaliesFinales = Array.from(new Set([
            ...
            ...(scanPhase === "arrivee" && pleinArrivee ? ["Plein de carburant effectué à l'arrivée"] : []),
        ]));
