    ...
    const vehiculesDisponibles = useMemo(() => {
        return vehicules.filter(v => {
            return !trajets.some(t =>
                t.vehiculeId === v.id &&
                t.conducteurId &&
                !t.heureArrivee // si pas d'heureArrivee => indisponible
            );
        });
    }, [vehicules, trajets]);
    ...
    const filteredTrajets = useMemo(() => {
        ...
        return trajets
            .filter(t => {
                ...
                // Filtre disponibles selon vehiculesDisponibles
                ...
                const matchesHeure =
                    (!heureStart || t.heureDepart >= heureStart) &&
                    (!heureEnd || t.heureArrivee <= heureEnd);
        ...
        <div className="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-md mt-6 p-4">
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 text-sm">
                    ...
                    <tr>
                        {["Type","Modèle","Énergie","Immatriculation","Km total","Conducteur","Destination","Km départ","Km arrivée","Heure départ","Heure arrivée","Durée","État","Actions"].map(t => (
                        ...
                        return (
                            ...
                            >
                                ...
                                <td className="px-4 py-3">
                                    {t.kmArrivee && (
                                        <button
                                            onClick={(e) => { e.stopPropagation(); handleUpdateKmVehicule(vehicule?.id, t.kmArrivee); }}
