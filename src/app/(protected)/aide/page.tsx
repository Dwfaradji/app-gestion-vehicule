...
const faqs: FAQItem[] = [
    {
        ...
        answer: "Allez dans la section 'Véhicules' puis cliquez sur 'Ajouter un véhicule'. Remplissez les informations et sauvegardez."
    },
    {
        question: "Comment enregistrer une dépense ?",
        answer: "Dans la fiche du véhicule, cliquez sur 'Ajouter dépense', choisissez la catégorie et saisissez le montant."
    },
    {
        question: "Comment exporter les données ?",
        answer: "Utilisez le menu 'Exporter les données' en haut à droite pour télécharger les véhicules, trajets ou dépenses au format PDF."
    },
    {
        ...
        <div className="min-h-screen bg-gray-50 p-6 space-y-6 ">
            ...
            <div className="mt-8 p-4 bg-blue-50 border-l-4 border-blue-400 rounded-lg bottom-0 fixed w-full text-center">
                ...
                <p className="text-blue-800">
                    Contactez notre support à <a href="mailto:contact@devevoke.com" className="underline">contact@devevoke.com</a>.
                </p>
            </div>
        </div>
    );
