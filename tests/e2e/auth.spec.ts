...
test.describe("Authentification", () => {
  ...
  test('UTILISATEUR (non-admin) peut se connecter et est redirigé vers le tableau de bord', async ({ page }) => {
  ...
  test('un visiteur non authentifié allant sur /dashboard est redirigé vers /login', async ({ page }) => {
